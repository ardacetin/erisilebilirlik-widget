...
Harici web sitelerine `<script>` etiketiyle eklenebilen, erişilebilirliği artırmaya yönelik yeniden kullanılabilir bir arayüz sunar. Bileşen; yüksek kontrast, ayarlanabilir kontrast düzeyi, metin boyutu, satır aralığı, büyüteç, disleksi dostu yazı tipi, bağlantı vurgulama, renk filtreleri ve animasyonları durdurma gibi kontroller içerir ve odak yönetimi, ARIA etiketleri ile yerelleştirme desteği sağlar. Kontrast ve renk filtreleri birlikte kullanıldığında dahi görsel ayarlar aynı anda uygulanır.
